    ...
    def track_video(self,video:str, output:str, skip_frames:int=0, show_live:bool=False, count_objects:bool=False, verbose:int = 0):
        ...
        while True: # while video is running
            ...
            for track in self.tracker.tracks:  # update new findings AKA tracks
                ...
                # area_1 = [(126,680),(542,544),(476,497),(164,583)]
                # area_2 = [(180,515),(669,622),(107,733),(718,671)]

                # area_1 = [(126,680),(542,544),(476,497),(164,583)]
                # area_2 = [(180,515),(669,622),(126,680),(718,671)]

                area_1 = [(180,520),(475,499),(530,548),(163,583)]    ##############################
                ...
                if result>=0:
                    ...
                    vehicles_entering[track.track_id]=time.time()
                # print(vehicles_entering)
                if track.track_id in vehicles_entering:    
                    ...
                    if result>0:
                        ...
                        #cv2.line(frame, (107,733), (718,671), [0,0,50], 2)
