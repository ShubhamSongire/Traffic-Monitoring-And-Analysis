...
tracker.track_video(r"D:\Freelancing\Vehicle YOLO\results\test videos\videoplayback (2).mp4", output=r"E:\downloads\video2.mp4",show_live = True, skip_frames = 0, count_objects = True, verbose=1)
